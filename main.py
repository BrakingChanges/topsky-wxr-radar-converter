...
@app.get("/v2/radar/{timestamp}/{size}/{z}/{lat}/{lon}/{color}/{options}.png")
async def weather_tile_proxy_lat_lon(timestamp: int, size: int, z: int, lat: float, lon: float, color: int, options: str):
